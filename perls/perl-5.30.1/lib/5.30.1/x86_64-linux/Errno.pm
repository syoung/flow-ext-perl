...
"x86_64-linux-4.9.184-linuxkit" or
	die "Errno architecture (x86_64-linux-4.9.184-linuxkit) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
