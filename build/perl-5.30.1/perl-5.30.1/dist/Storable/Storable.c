...
#line 7862 "Storable.xs"
    RETVAL = pretrieve(aTHX_ f, flag);
#line 8027 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
