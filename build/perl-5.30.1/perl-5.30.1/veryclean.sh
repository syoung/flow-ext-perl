...
if test ! -f Makefile -a -f Makefile.old; then
    ...
    make -f Makefile.old veryclean MAKE='/Library/Developer/CommandLineTools/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.a
else
    if test ! -f Makefile ; then
	echo "Warning: No Makefile!"
    fi
    /Library/Developer/CommandLineTools/usr/bin/make veryclean MAKE='/Library/Developer/CommandLineTools/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.a
fi
cd ../..
...
if test ! -f Makefile -a -f Makefile.old; then
    echo "Note: Using Makefile.old"
    make -f Makefile.old veryclean MAKE='/Library/Developer/CommandLineTools/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.a LINKTYPE=static CCCDLFLAGS=
else
    if test ! -f Makefile ; then
	echo "Warning: No Makefile!"
    fi
    /Library/Developer/CommandLineTools/usr/bin/make veryclean MAKE='/Library/Developer/CommandLineTools/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.a LINKTYPE=static CCCDLFLAGS=
fi
cd ../..
cd ext/B
if test ! -f Makefile -a -f Makefile.old; then
    echo "Note: Using Makefile.old"
    make -f Makefile.old veryclean MAKE='/Library/Developer/CommandLineTools/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.a LINKTYPE=dynamic
else
    if test ! -f Makefile ; then
	echo "Warning: No Makefile!"
    fi
    /Library/Developer/CommandLineTools/usr/bin/make veryclean MAKE='/Library/Developer/CommandLineTools/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.a LINKTYPE=dynamic
fi
cd ../..
