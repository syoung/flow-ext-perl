package ActiveState::YAML::CPAN::YAML::Error;
use strict;
...
sub new {
    ...
    $msg =~ s/\\n/\n/g;
    $class = 'ActiveState::YAML::CPAN::YAML::Warning' if $severity eq 'WARN';
...
sub dump {
    my ($self) = @_;
    local $ActiveState::YAML::CPAN::YAML::Indent = 4;
    local $ActiveState::YAML::CPAN::YAML::UseHeader = 1;
    local $ActiveState::YAML::CPAN::YAML::UseVersion = 0;
    local $ActiveState::YAML::CPAN::YAML::SortKeys = [qw(code msg line document)];
    ActiveState::YAML::CPAN::YAML::Dump($self)
} 
...
YAML_LOAD_USAGE
  usage: ActiveState::YAML::CPAN::YAML::Load($yaml_stream_scalar)
...
YAML_LOAD_WARN_CODE_DEPARSE
  Won't parse Perl code unless $ActiveState::YAML::CPAN::YAML::LoadCode is set
...
package ActiveState::YAML::CPAN::YAML::Warning;
use base 'ActiveState::YAML::CPAN::YAML::Error';
