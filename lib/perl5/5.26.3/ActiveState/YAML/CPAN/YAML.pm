package ActiveState::YAML::CPAN::YAML;
$VERSION = '0.36';
...
use strict;
use ActiveState::YAML::CPAN::YAML::Node;
use ActiveState::YAML::CPAN::YAML::Transfer;
use Carp;
...
sub new {
    ...
    my $o = {
             ...
             level => 0,
             anchor => 1,
             Indent => $ActiveState::YAML::CPAN::YAML::Indent,
             UseHeader => $ActiveState::YAML::CPAN::YAML::UseHeader,
             UseVersion => $ActiveState::YAML::CPAN::YAML::UseVersion,
             SortKeys => $ActiveState::YAML::CPAN::YAML::SortKeys,
             AnchorPrefix => $ActiveState::YAML::CPAN::YAML::AnchorPrefix,
             DumpCode => $ActiveState::YAML::CPAN::YAML::DumpCode,
             LoadCode => $ActiveState::YAML::CPAN::YAML::LoadCode,
             UseBlock => $ActiveState::YAML::CPAN::YAML::UseBlock,
             UseFold => $ActiveState::YAML::CPAN::YAML::UseFold,
             CompressSeries => $ActiveState::YAML::CPAN::YAML::CompressSeries,
             InlineSeries => $ActiveState::YAML::CPAN::YAML::InlineSeries,
             UseAliases => $ActiveState::YAML::CPAN::YAML::UseAliases,
             Purity => $ActiveState::YAML::CPAN::YAML::Purity,
             DateClass => $ActiveState::YAML::CPAN::YAML::DateClass,
            };
    bless $o, $class;
    set_default($o, 'DumpCode', $ActiveState::YAML::CPAN::YAML::UseCode);
    set_default($o, 'LoadCode', $ActiveState::YAML::CPAN::YAML::UseCode);
    return $o if is_valid($o);
}

my $global = {}; # A global lookup
sub Bless { ActiveState::YAML::CPAN::YAML::bless($global, @_) }
sub Blessed { ActiveState::YAML::CPAN::YAML::blessed($global, @_) }

sub blessed {
    my ($o, $ref) = @_;
    $ref = \$_[0] unless ref $ref;
    my (undef, undef, $node_id) = ActiveState::YAML::CPAN::YAML::Node::info($ref);
    $o->{blessed}{$node_id};
}
...
sub bless {
    ...
    if (not defined $blessing) {
        $ynode = ActiveState::YAML::CPAN::YAML::Node->new($ref);
    }
    elsif (ref $blessing) {
...
sub DumpFile {
    ...
    print MYYAML ActiveState::YAML::CPAN::YAML::Dump(@_);
    close MYYAML;
}
    
# Serialize a list of elements
sub Dump {
    $o = ActiveState::YAML::CPAN::YAML->new();
    $o->dump(@_);
}
...
# OO version of Dump. ActiveState::YAML::CPAN::YAML->new->dump($foo); 
sub dump {
    $o = shift; 
...
sub _prewalk {
    my $value;
    my ($class, $type, $node_id) = ActiveState::YAML::CPAN::YAML::Node::info(\$_[0]);
    # Handle typeglobs
    if ($type eq 'GLOB') {
        $value = $o->{transferred}{$node_id} = 
          ActiveState::YAML::CPAN::YAML::Transfer::glob::yaml_dump($_[0]);
        return _prewalk($value);
    }
    # Handle regexps
    if (ref($_[0]) eq 'Regexp') {  
        $o->{transferred}{$node_id} = ActiveState::YAML::CPAN::YAML::Transfer::regexp::yaml_dump($_[0]);
        return;
    }
    ...
    $value = $_[0];
    ($class, $type, $node_id) = ActiveState::YAML::CPAN::YAML::Node::info($value);
    # Look for things already transferred.
    if ($o->{transferred}{$node_id}) {
        (undef, undef, $node_id) = (ref $o->{transferred}{$node_id})
          ? ActiveState::YAML::CPAN::YAML::Node::info($o->{transferred}{$node_id})
          : ActiveState::YAML::CPAN::YAML::Node::info(\ $o->{transferred}{$node_id});
        $o->{id_refcnt}{$node_id}++;
        return;
    }
    ...
    if ($type eq 'CODE') {
        ...
        ActiveState::YAML::CPAN::YAML::Transfer::code::yaml_dump($o->{DumpCode},
                                        $_[0], 
    ...
    # Handle blessed things
        ...
        if ($class eq $o->{DateClass}) {
            ...
            ActiveState::YAML::CPAN::YAML::Transfer::blessed::yaml_dump
            ...
            $value = ActiveState::YAML::CPAN::YAML::Transfer::blessed::yaml_dump($value);
        }
        $o->{transferred}{$node_id} = $value;
        (undef, $type, $node_id) = ActiveState::YAML::CPAN::YAML::Node::info($value);
    }
    ...
    if ($type eq 'REF' or $type eq 'SCALAR') {
        $value = ActiveState::YAML::CPAN::YAML::Transfer::ref::yaml_dump($value);
        $o->{transferred}{$node_id} = $value;
        (undef, $type, $node_id) = ActiveState::YAML::CPAN::YAML::Node::info($value);
    }
    # Handle ref-to-glob's
        ...
        my $ref_ynode = $o->{transferred}{$node_id} =
          ActiveState::YAML::CPAN::YAML::Transfer::ref::yaml_dump($value);

        my $glob_ynode = $ref_ynode->{&VALUE} = 
          ActiveState::YAML::CPAN::YAML::Transfer::glob::yaml_dump($$value);

        (undef, undef, $node_id) = ActiveState::YAML::CPAN::YAML::Node::info($glob_ynode);
...
sub _emit_node {
    ...
    if ($ref and $ref ne 'Regexp') {
        (undef, $type, $node_id) = ActiveState::YAML::CPAN::YAML::Node::info($_[0]);
    }
    else {
        $type = $ref || 'SCALAR';
        (undef, undef, $node_id) = ActiveState::YAML::CPAN::YAML::Node::info(\$_[0]);
    }
...
sub _emit_mapping {
    ...
    # Force the ActiveState::YAML::CPAN::YAML::VALUE ('=') key to sort last.
...
# $|=1;
# print <<END;
# _parse_node ${\++$ActiveState::YAML::CPAN::YAML::x}
# indent  - $o->{indent}
# preface - $o->{preface}
# content - $o->{content}
# level   - $o->{level}
...
sub _parse_explicit {
    ...
    if ($explicit =~ m{^(int|float|bool|date|time|datetime|binary)$}) {
        my $handler = "ActiveState::YAML::CPAN::YAML::_load_$1";
        no strict 'refs';
        return &$handler($node);
    }
    elsif ($explicit =~ m{^perl/(glob|regexp|code|ref)\:(\w(\w|\:\:)*)?$}) {
        my ($type, $class) = (($1 || ''), ($2 || ''));
        my $handler = "ActiveState::YAML::CPAN::YAML::_load_perl_$type";
        no strict 'refs';
        if (defined &$handler) {
        ...
        no strict 'refs';
        if (defined &$handler) {
            return &$handler(ActiveState::YAML::CPAN::YAML::Node->new($node, $explicit));
        }
        else {
        ...
        return ActiveState::YAML::CPAN::YAML::Node->new($node, $explicit);
    }
}
...
sub AUTOLOAD {
    (my $autoload = $ActiveState::YAML::CPAN::YAML::AUTOLOAD) =~ s/^ActiveState::YAML::CPAN::YAML:://;
    if ($autoload =~ /^[A-Z]/ and 
        ref($_[0]) eq 'YAML' and
    ...
    croak "Can't autoload '$ActiveState::YAML::CPAN::YAML::AUTOLOAD'\n"
      unless $autoload =~ /^YAML_(PARSE|LOAD|DUMP|EMIT)_(ERR|WARN|USAGE)/;
    require ActiveState::YAML::CPAN::YAML::Error;  
    $o->{error} = ActiveState::YAML::CPAN::YAML::Error->new($autoload, $o->{line}, $o->{document}, @_);
    my $o_save = $o;
